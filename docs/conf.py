# -*- coding: utf-8 -*-
#
# telegraf-kafka documentation build configuration file, created by
...
htmlhelp_basename = 'telegraf-kafkadoc'
...
latex_documents = [
    (master_doc, 'telegraf-kafka.tex', u'telegraf-kafka Documentation',
...
man_pages = [
    (master_doc, 'da-itsi-telegraf-kafka', u'telegraf-kafka Documentation',
     [author], 1)
]
